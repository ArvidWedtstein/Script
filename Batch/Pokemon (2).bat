...
cls
for %%i in ( P r o f . " " O a k " " a p p r o c h i a t e s ) do (<nul set /p "=.%bs%%%~i" & >nul ping -n 1 localhost)
echo.
for %%i in ( P r o f . " " O a k : " " H i . " " M y " " n a m e " " i s " " P r o f . " " O a k . ) do (<nul set /p "=.%bs%%%~i" & >nul ping -n 1 localhost)
echo.
for %%i in ( P r o f . " " O a k : " " W e l c o m e " " t o " " t h e " " w o n d e r f u l " " w o r l d " " o f " " P o k e m o n ! ) do (<nul set /p "=.%bs%%%~i" & >nul ping -n 1 localhost)
echo.
pause
...
cls
for %%i in ( H i " " %name% ! " " I t ' s " " n i c e " " s e e i n g " " y o u " " a g a i n ! ) do (<nul set /p "=.%bs%%%~i" & >nul ping -n 1 localhost)
echo Hi %name%! It's nice seeing you again
pause

::girlorboy
::cls
::for %%i in ( %name% , " " A r e " " y o u " " a " " b o y " " o r " " a " " g i r l ? ) do (<nul set /p "=.%bs%%%~i" & >nul ping -n 1 localhost)
...
::cls
:for %%i in ( P r o f . " " O a k : " " A a h . . " " s o " " y o u " " a r e " " a " " %gender% ) do (<nul set /p "=.%bs%%%~i" & >nul ping -n 1 localhost)
::pause

cls
echo.
for %%i in ( P r o f . " " O a k : " " S o " " %name% " " w h a t " " a r e " " y o u " " w a i t i n g " " f o r ? " " C h o o s e " " y o u r " " p o k e m o n . ) do (<nul set /p "=.%bs%%%~i" & >nul ping -n 1 localhost)
pause
...
for %%i in ( P r o f . " " O a k : " " D o " " y o u " " w a n t " " t o " " p i c k " " B u l b a s a u r ? ) do (<nul set /p "=.%bs%%%~i" & >nul ping -n 1 localhost)
echo. 
for %%i in ( E n t e r " " y " " t o " " c h o o s e " " B u l b a s a u r ) do (<nul set /p "=.%bs%%%~i" & >nul ping -n 1 localhost)
echo.
pause
set /p yno=
