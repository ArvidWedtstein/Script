...
echo/
powershell write-host -fore Red -back Black -NoNewLine "Kodet av:" ; write-host -fore Black -back Black -NoNewLine "/" ; write-host -back Black -fore DarkRed "Arvid og Erling" 
echo/
