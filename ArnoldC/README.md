...
To compile `.arnoldc` script to java:
`java -jar ArnoldC.jar <file>.arnoldc`

and to run the java file: `java <file>`

Wiki for more details: https://github.com/lhartikk/ArnoldC/wiki/ArnoldC
...
Every ArnoldC program has to start with `IT'S SHOWTIME` and end with `YOU HAVE BEEN TERMINATED`
